Page({
  data: {
    ...
    eid:"",
    index:0,
    top: [0, 640, 867, 1153, 1498, 1607, 1775, 2061, 2288, 2574, 2683, 3323, 3727, 3954, 4122, 4290, 4517, 4685, 5030, 5434, 5897, 6360, 6646],
    "code": 0,
    animation: "",
    "data": {
      "list": [{
  ...
  onLoad: function() {
    ...
    if (this.data.code == 0) {
      that.setData({
        logs: that.Singer(this.data.data.list)
      })
    }
  },

  zimu(e) {
    var index = this.data.logs.findIndex((item) => item.title == e.target.dataset.id);
      var animation = wx.createAnimation({
        duration: 1000,
        timingFunction: "linear",
      });
      this.animation = animation;
      animation.translateY(-this.data.top[index]).step();
      this.setData({
